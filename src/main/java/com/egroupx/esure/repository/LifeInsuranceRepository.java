...
public interface LifeInsuranceRepository extends ReactiveCrudRepository<MemberDTO,Long> {
    ...
    @Query("SELECT policy_number FROM esure_members order by id desc limit 1")
    Mono<String> getLatestPolicyNumber();
