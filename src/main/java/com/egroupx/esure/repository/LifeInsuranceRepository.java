...
public interface LifeInsuranceRepository extends ReactiveCrudRepository<MemberDTO,Long> {
    ...
    @Query("INSERT IGNORE INTO spouses SET  client=:client, title=:title, firstName=:first_name, surname=:surname, id_number=:idNumber, gender=:gender,date_of_birth=:dateOfBirth, age=:age, main_member_id=:mainMemberId, policy_number=:policyNumber")
    ...
    @Query("INSERT IGNORE INTO ext_dependents SET client=:client, title =:title, first_name=:firstName, surname=:surname, id_number=:idNumber, gender=:gender,date_of_birth=:dateOfBirth, age=:age, main_member_id=:mainMemberId, policy_number=:policyNumber, relation=:relation")
    ...
    @Query("INSERT IGNORE INTO dependents SET client=:client, title=:title, first_name=:firstName, surname=:surname, id_number=:idNumber, gender=:gender,date_of_birth=:dateOfBirth, age=:age, main_member_id=:mainMemberID, policy_number=:policyNumber")
