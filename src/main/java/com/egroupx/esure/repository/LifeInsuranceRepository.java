...
public interface LifeInsuranceRepository extends ReactiveCrudRepository<Member,Long> {
    ...
    @Query("INSERT IGNORE INTO spouses SET  client=:client, title=:title, firstName=:firstName, surname=:surname, idNumber=:idNumber, gender=:gender,date_of_birth=:dateOfBirth, age=:age, main_member_id=:mainMemberId, policy_number=:policyNumber")
    ...
    Mono<Dependent> saveDependent(String client, String title, String firstName, String surname, String idNumber, String gender, LocalDate dateOfBirth, String age, String mainMemeberID, String policyNumber);

    @Query("INSERT IGNORE INTO beneficiaries SET policyNumber=:policyNumber, client=:client, contact_cell=:contactCell, contact_work_tell=:contactWorkTell, contact_home_tell=:contactHomeTell, contact_fax=:contactFax, contact_email=:contactEmail, session_user_id=:sessionUserID, pref_type=:prefType, ben_last_name=:benLastName, ben_first_name=:benFirstName, ben_id_number=:benIdNumber, ben_percentage=:benPercentage ,ben_dob=:benDOB, ben_relation=:benRelation, ben_type=:benType, title=:title")
